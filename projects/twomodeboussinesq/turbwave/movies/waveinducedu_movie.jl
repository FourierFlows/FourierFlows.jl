...
jldopen(filename, "r") do file
  ...
  for (istep, step) in enumerate(steps)
    ...
    plot2 = pcolormesh(x, y, uc, cmap="RdBu_r", vmin=-sp0, vmax=sp0)
    contour(x, y, Chi, ncontours, colors="k", linewidths=0.5, alpha=0.3)
