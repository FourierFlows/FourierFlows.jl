...
module FourierFlowTypes

# This module provides abstract types that are useful for 
# organizing FourierFlow code.

export AbstractVars, AbstractParams, AbstractGrid, AbstractEquation
...
# This module provides a 'Grid' type with physical grid, wavenumbers
# wavenumber-derived quantities, Fourier transform plans, 
# and a dealiasing function.

using FourierFlowTypes
